<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/Users/zhujunjie/www/guochen/public/../apps/admin/view/role/add.html";i:1508406309;s:73:"/Users/zhujunjie/www/guochen/public/../apps/admin/view/public/header.html";i:1507736765;s:73:"/Users/zhujunjie/www/guochen/public/../apps/admin/view/public/footer.html";i:1508229501;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t form-post-submit add-submit-form" action="/role/add" method="post">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">角色名称 ：</label>
                        <div class="col-sm-4">
                            <input name="auth_name" type="text" value="" class="form-control" required autofocus="autofocus">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php if(is_array($node) || $node instanceof \think\Collection): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                             <label><input type="checkbox" name="admin_code[]" value="<?php echo $v['id']; ?>">&nbsp;<?php echo $v['remark']; ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <input type="radio" name="action_code" id="action_code0" value="2" checked>
                                </div>
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <input type="radio" name="action_code" id="action_code1" value="1">
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <input type="radio" name="sell_code" id="sell_code0" value="2" checked>
                                </div>
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <input type="radio" name="sell_code" id="sell_code1" value="1">
                                </div>
